...
public class ExitScreen extends BasicGameState {
    ...
    public boolean isYesExit = false;
    public boolean isNoExit = false;
    public String mouse = "";
    ...
    public void render(GameContainer gameContainer, StateBasedGame stateBasedGame, Graphics graphics) throws SlickException {
        Image ExitScreen = new Image("res/Images/ExitScreen.png");
        Image yes = new Image("res/Images/ExitYesButton.png");
        Image no = new Image("res/Images/ExitNoButton.png");
